...
public class LocalThisTest extends TypeCheckingTestCase {
  ...
  public void thisRecursiveError() {
    typeCheckModule("""
      ...
      \\func ext => R { | X => Nat | x n => R.f {\\this} n n }
      """, 1);
  ...
  public void thisRecursiveExtError2() {
    typeCheckModule("""
      ...
      \\record R \\extends S
        | y : X -> X
      \\func test => \\new (R { | X => Nat | y n => S.f {\\this} n n }) { | x => R.y {\\this} }
      """, 1);
    assertThatErrorsAre(cycle());
  }
  ...
  public void thisError() {
    typeCheckModule("""
      ...
      \\record R \\extends S
        | y : X -> X
      \\func f (s : S) => s.x
      \\func test => R { | y t => f (\\let y => \\this \\in y) t }
      """, 1);
  }
