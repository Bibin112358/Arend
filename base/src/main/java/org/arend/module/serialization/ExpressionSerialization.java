...
class ExpressionSerialization implements ExpressionVisitor<Void, ExpressionProtos.Expression> {
  ...
  @Override
  public ExpressionProtos.Expression visitString(StringExpression expr, Void params) {
    return ExpressionProtos.Expression.newBuilder().setString(ExpressionProtos.Expression.String.newBuilder().setValue(expr.getString())).build();
  }
  ...
  @Override
  public ExpressionProtos.Expression visitPath(PathExpression expr, Void params) {
  ...
  @Override
  public ExpressionProtos.Expression visitAt(AtExpression expr, Void params) {
