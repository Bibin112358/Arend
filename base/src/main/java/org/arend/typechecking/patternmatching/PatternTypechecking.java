      ...
      if (conResult.exprs == null) {
        ...
        if (dataCall != null) {
          ...
          if (elementsType != null) {
            elementsType = elementsType.subst(classCall.getThisBinding(), new NewExpression(null, new ClassCallExpression(Prelude.DEP_ARRAY, classCall.getLevels(), new SingletonMap<>(Prelude.ARRAY_LENGTH, constructor == Prelude.EMPTY_ARRAY ? Zero() : length != null ? length : Suc(conResult.exprs.getFirst())), UniverseKind.NO_UNIVERSES)));
          }
