...
public class ConcreteExpressionFactory {
  ...
  public static Concrete.ReferenceExpression cDefCall(Object data, LongName longName, Referable referable, List<Concrete.LevelExpression> pLevels) {
    return longName == null
      ? new Concrete.ReferenceExpression(data, referable, pLevels)
      : new Concrete.LongReferenceExpression(data, null, longName, referable, pLevels);
  }
  ...
  public static Concrete.LetExpression cLet(List<Concrete.LetClause> clauses, Concrete.Expression expr) {
    return new Concrete.LetExpression(null, false, false, clauses, expr);
  }
  ...
  public static Concrete.TypeParameter cTypeArg(boolean explicit, Concrete.Expression type) {
    return new Concrete.TypeParameter(explicit, type, false);
  }

  public static Concrete.TypeParameter cTypeArg(Concrete.Expression type) {
    return new Concrete.TypeParameter(true, type, false);
  }
  ...
  public static Concrete.TelescopeParameter cTele(boolean explicit, List<? extends Referable> referableList, Concrete.Expression type) {
    return new Concrete.TelescopeParameter(null, explicit, referableList, type, false);
  }
  ...
  public static Concrete.TelescopeParameter cTele(Object data, boolean explicit, List<? extends Referable> referableList, Concrete.Expression type) {
    return new Concrete.TelescopeParameter(data, explicit, referableList, type, false);
  }
  ...
  public static Concrete.TuplePattern cTuplePattern(boolean isExplicit, List<Concrete.Pattern> patternArgs) {
    return new Concrete.TuplePattern(null, isExplicit, patternArgs, null);
  }
  ...
  public static Concrete.TuplePattern cEmptyPattern(boolean isExplicit) {
    return new Concrete.TuplePattern(null, isExplicit, Collections.emptyList(), null);
  }
