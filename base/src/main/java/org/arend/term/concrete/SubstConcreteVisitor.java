...
public class SubstConcreteVisitor extends BaseConcreteExpressionVisitor<Void> implements DataContainer, ConcreteLevelExpressionVisitor<Void, Concrete.LevelExpression> {
  ...
  public Concrete.Expression visitFieldCall(Concrete.FieldCallExpression expr, Void params) {
    return new Concrete.FieldCallExpression(myData != null ? myData : expr.getData(), expr.getField(), expr.fixity, expr.getArgument().accept(this, null));
  }
  ...
  public Concrete.Expression visitUniverse(Concrete.UniverseExpression expr, Void ignored) {
    ...
    return new Concrete.UniverseExpression(myData == null ? expr.getData() : myData, expr.getPLevel() == null ? null : expr.getPLevel().accept(this, null), expr.getHLevel() == null ? null : expr.getHLevel().accept(this, null), expr.getKind());
  }
