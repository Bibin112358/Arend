...
import org.arend.codeInsight.completion.ArendReplCompletionContributor.Companion.getReplCommand
    ...
    companion object {
        ...
        private val expressionPattern = { allowInBareSigmaOrPiExpressions: Boolean, allowInArgumentExpressionContext: Boolean ->
            not(or(after(withAncestors(ArendAtomFieldsAcc::class.java)), //No keyword completion after field
                ...
                after(ofType(SET, CAT_UNIVERSE, PROP_KW, SET_KW, SORT_KW, UNIVERSE, TRUNCATED_UNIVERSE, NEW_KW, EVAL_KW, PEVAL_KW)), //No expression keyword completion after universe literals or \new keyword
