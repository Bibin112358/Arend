...
class ShrinkAbstractVisitor(val textRange: TextRange) : AbstractExpressionVisitor<Unit, String> {
    ...
    override fun visitUniverse(data: Any?, pLevelNum: Int?, hLevelNum: Int?, pLevel: Abstract.LevelExpression?, params: Unit?): String =
            """\Type"""

    override fun visitCatUniverse(data: Any?, pLevelNum: Int?, pLevel: Abstract.LevelExpression?, params: Unit?): String =
            """\Cat"""

    override fun visitSortUniverse(data: Any?, params: Unit?): String = """\Sort"""
