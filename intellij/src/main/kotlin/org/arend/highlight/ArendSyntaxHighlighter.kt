...
class ArendSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    companion object {
        fun map(tokenType: IElementType?): ArendHighlightingColors? = when (tokenType) {
            ...
            ArendElementTypes.PROP_KW, ArendElementTypes.SORT_KW, ArendElementTypes.SET, ArendElementTypes.CAT_UNIVERSE, ArendElementTypes.UNIVERSE, ArendElementTypes.TRUNCATED_UNIVERSE -> ArendHighlightingColors.UNIVERSE
